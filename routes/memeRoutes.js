...
import { uploadImages, uploadMemeData } from '../services/uploadService.js'
 ...
 */
router.post('/', token, isUser, blockBannedUser, uploadMemeData, validateCreateMeme, createMeme)
